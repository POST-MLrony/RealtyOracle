...
def preprocess_pipeline(
    ...
    df = find_nearest_neighbors(df, "la", "lo", n_neighbors=11)
    ...
    if need_isolation_trim:
        ...
        df = filter_outliers_with_isolation_forest(isolation_df)
    return df
...
def train_pipeline(
    ...
    if model_type == "catboost":
        ...
        model = CatBoostRegressor(
            cat_features=categories, verbose=100, iterations=5000, loss_function= loss
        )
